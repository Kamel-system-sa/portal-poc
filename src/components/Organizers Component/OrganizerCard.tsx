...
export const OrganizerCard = ({ organizer, onShowDetails, translateNationality, t }: OrganizerCardProps) => {
  return (
    ...
    >
      {/* Header with Image */}
      <div className="relative bg-gradient-to-br from-mainColor/10 to-primary/10 p-3">
        ...
        <div className="text-center">
          <Text className="text-sm font-semibold text-gray-700 block mb-1">
            {organizer.organizerName}
          </Text>
          <Text className="text-base font-bold text-gray-800 block truncate">
            {organizer.company}
          </Text>
          <Tag className="mt-1.5 rounded-full text-xs bg-primary/10 text-primary border-primary/20">
      ...
      <div className="p-3 space-y-3">
        <div className="grid grid-cols-2 gap-2.5">
          <div className="bg-mainColor/5 rounded-lg p-2">
        ...
        <div className="bg-gradient-to-r from-mainColor/10 to-primary/10 rounded-lg p-2.5 border-l-2 border-mainColor">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5">
              <TeamOutlined className="text-mainColor text-base" />
              <Text className="text-sm text-gray-600">{t("hajjCount")}</Text>
            </div>
